# Setup Guide — David Buys Homes For Cash Websites

## Domains

| Domain | Brand | Status |
|--------|-------|--------|
| davidbuyshomes4cash.com | Personal (David) | DNS complete |
...
6. Add `davidbuyshomes4cash.com` and `www.davidbuyshomes4cash.com`
7. Cloudflare will auto-provision SSL certificate
8. Verify site loads at https://davidbuyshomes4cash.com
...
const CONFIG = {
  ...
  domain: 'davidbuyshomes4cash.com',
...
3. Create an API key, restrict to:
   - HTTP referrers: `davidbuyshomes4cash.com/*`, `washingtonhomes4cash.com/*`, `washingtonhomeoffers.com/*`
...
### Domain 1: davidbuyshomes4cash.com

1. Go to https://business.google.com → "Add your business"
2. **Business name:** David Buys Homes For Cash
...
8. **Website:** https://davidbuyshomes4cash.com
9. **Hours:** Mon-Sat 8:00 AM - 7:00 PM
10. **Description:**
```
David Buys Homes For Cash is a local real estate investment company serving homeowners across Washington State. We buy houses in any condition — no repairs needed, no agent commissions, no hidden fees.
...
Get your instant cash offer at davidbuyshomes4cash.com — see your comps and your offer in under 60 seconds.
```
...
- **Description:** Same but replace "David Buys Homes For Cash" with "Washington Homes 4 Cash" and domain with washingtonhomes4cash.com
...
2. Find-and-replace in all HTML files:
   - "David Buys Homes For Cash" → new brand name
   - "davidbuyshomes4cash.com" → new domain
   - "david@davidbuyshomes4cash.com" → new email
